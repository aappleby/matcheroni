...
["_main","getExceptionMessage","___get_exception_message","_free","_memory","_fflush","___emscripten_embedded_file_data","___indirect_function_table","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'json_tut1c.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('json_tut1c.wasm', import.meta.url).href;
}
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 33572400;
