...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'json_tut1a.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('json_tut1a.wasm', import.meta.url).href;
}
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 33572812;
