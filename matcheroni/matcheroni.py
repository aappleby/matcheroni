...
def Railway(railway):
    ...
    2. '(' can be followed by an expression, a declaration, or a ')'
    3. Expressions can be followed by a comma or ')'
    4. Declarations can be followed by a comma or ')'
    5. Commas can be followed by another expression, declaration, or ')'
    6. ')' terminates the match
    """
