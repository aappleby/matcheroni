...
void CScope::add_type(const CLexeme* a, token_list& types) {
...
void CScope::add_class_type  (const CLexeme* a) { return add_type(a, class_types  ); }
void CScope::add_struct_type (const CLexeme* a) { return add_type(a, struct_types ); }
void CScope::add_union_type  (const CLexeme* a) { return add_type(a, union_types  ); }
void CScope::add_enum_type   (const CLexeme* a) { return add_type(a, enum_types   ); }
void CScope::add_typedef_type(const CLexeme* a) { return add_type(a, typedef_types); }
